...
const InstructorDashboard = () => {
  ...
  return (
    <div className="flex" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
      <Sidebar />
      <div className="flex-grow p-4 mt-5">
        ...
        {/* Third Card (larger) */}
        <div className="bg-white p-6 rounded-lg shadow-md mt-4 h-64">
